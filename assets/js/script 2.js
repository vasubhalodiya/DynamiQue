    ...
    window.tram = (function (e) {
      ...
      var p = (function (l, y, T) {
          ...
          function K(te, ve) {
            ...
            function ae() {}
            ve === T && ((ve = te), (te = Object)), (W.Bare = ae);
            var se,
              Ie = (R[l] = te[l]),
              ot = (ae[l] = W[l] = new R());
            return (
              ...
              (W.open = function (Pe) {
                if (
                  ...
                  for (var br in se) y.call(se, br) && (ot[br] = se[br]);
                return m(ot.init) || (ot.init = te), W;
              }),
              W.open(ve)
            );
          }
      ...
      if (V.transition) {
        var Q = V.timing.dom;
        if (((X.style[Q] = _["ease-in-back"][0]), !X.style[Q]))
          for (var ee in O) _[ee][0] = O[ee];
      }
      var F = (t.frame = (function () {
        ...
        f = p(function (l) {
          function y(Z, ue) {
            ...
            if (!ue.weak || !this.props[fe]) {
              var Ke = Le[0],
                Ge = this.props[fe];
              return (
                Ge || (Ge = this.props[fe] = new Ke.Bare()),
            ...
            if (Z) {
              ...
              if (fe == "object") {
                ...
                ot.call(
                  ...
                  Z,
                  function (Te, _m) {
                    Te.span > Le && (Le = Te.span), Te.stop(), Te.animate(_m);
                  },
                  function (Te) {
                ...
                F(function () {
                  ot.call(Ke, Z, function (Te) {
                    Te.active && ((Ge = !0), (sn[Te.name] = Te.nextStyle));
                  }),
                    Ge && Ke.$el.css(sn);
                });
              }
          ...
          function te(Z) {
            K.call(this, Z), ot.call(this, Z, br, Em);
          }
          function ve(Z) {
                ...
                fe in qe
                  ...
                  : (N.test(fe) && (fe = r(fe)),
                    fe in it
                      ...
                      : (Ge || (Ge = {}), (Ge[fe] = Ke)));
            for (fe in Te) {
              if (((Ke = Te[fe]), (Le = this.props[fe]), !Le)) {
                if (!sn) continue;
                Le = y.call(this, fe);
              }
              ue.call(this, Le, Ke);
          ...
          (l.init = function (Z) {
            ...
            V.backface &&
              le.hideBackface &&
              Ee(this.el, V.backface.css, "hidden");
          }),
            He("add", y),
            He("start", T),
            He("wait", A),
        ...
        E = p(f, function (l) {
          ...
          l.init = function (T, A) {
            ...
            if (m.length === 1) return y(m[0], A);
            var R = [];
            return (
              m.each(function (K, te) {
                R.push(y(te, A));
              }),
              (this.children = R),
              this
        ...
        g = p(function (l) {
          ...
          function T(R, K, te) {
            return K !== void 0 && (te = K), R in _ ? R : te;
          }
          function A(R) {
            var K = /rgba?\((\d+),\s*(\d+),\s*(\d+)/.exec(R);
            return (K ? o(K[1], K[2], K[3]) : R).replace(
              /#(\w)(\w)(\w)$/,
              "#$1$1$2$2$3$3"
            );
          }
              ...
              le.fallback || ve.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    (this.ease != "ease" ? J + _[this.ease][0] : "") +
            ...
            (l.convert = function (R, K) {
              ...
              switch (K) {
                ...
                case P:
                  ...
                  break;
                case U:
                  if (ve) return R + this.angle;
                  if (W && K.test(R)) return R;
                  te = "number(deg) or string(angle)";
                  break;
                case k:
                  if (ve || (W && P.test(R))) return R;
          ...
          (l.init = function () {
            ...
            (l.values = function (A) {
              var m,
                R = {};
              return (
                T.call(this, A, function (K, te, ve) {
                  (R[K] = te),
        ...
        Y = p(function (l) {
          ...
          var K = { ease: _.ease[1], from: 0, to: 1 };
          (l.init = function (W) {
            ...
            se === void 0 && (se = K.from),
              Ie === void 0 && (Ie = K.to),
              (this.unit = W.unit || ""),
              typeof se == "number" && typeof Ie == "number"
                ? ((this.begin = se), (this.change = Ie - se))
                : this.format(Ie, se),
            ...
            (l.format = function (W, ae) {
              ...
              if (!this.unit) {
                var se = ae.replace(C, ""),
                  Ie = W.replace(C, "");
                se !== Ie && s("tween", ae, W), (this.unit = se);
              }
              (ae = parseFloat(ae)),
                (W = parseFloat(W)),
      ...
      (t.fallback = function (l) {
        ...
        (t.delay = function (l, y, T) {
          return new ce({ complete: y, duration: l, context: T });
        }),
      ...
      (e.map = e.collect =
        ...
        (e.find = e.detect =
          function (I, D, G) {
            ...
            return (
              U(I, function (Q, ee, F) {
                if (D.call(G, Q, ee, F)) return (V = Q), !0;
              }),
              V
            );
          }),
        ...
        e.any =
          function (I, D, G) {
            ...
            return I == null
              ...
              ? I.some(D, G)
              : (P(I, function (Q, ee, F) {
                  if (V || (V = D.call(G, Q, ee, F))) return t;
                }),
                !!V);
          });
      (e.contains = e.include =
        ...
        (e.debounce = function (I, D, G) {
          var V,
            ...
            f = function () {
              ...
              E < D
                ? (V = setTimeout(f, D - E))
                : ((V = null), G || ((j = I.apply(ee, Q)), (ee = Q = null)));
            };
          return function () {
            (ee = this), (Q = arguments), (F = e.now());
            var E = G && !V;
            return (
              V || (V = setTimeout(f, D)),
              E && ((j = I.apply(ee, Q)), (ee = Q = null)),
              j
            );
          };
        }),
        (e.defaults = function (I) {
          ...
          for (var D = 1, G = arguments.length; D < G; D++) {
            var V = arguments[D];
            for (var Q in V) I[Q] === void 0 && (I[Q] = V[Q]);
          }
          return I;
        }),
        (e.keys = function (I) {
...
` +
  ...
  var Qe = u((PW, Ps) => {
    ...
    function Rs(e) {
      de.env() &&
        (at(e.design) && Ye.on("__wf_design", e.design),
    ...
    de.ready = function () {
      (cn = !0), Vi ? wm() : ze.each(zt, As), ze.each(Ui, As), de.resize.up();
    };
    function As(e) {
      at(e) && e();
    }
    ...
    function qs() {
      Pt && (Pt.reject(), Ye.off("load", Pt.resolve)),
        (Pt = new Tt.Deferred()),
    ...
    Ls.define(
      ...
      (Ms.exports = function (e) {
        ...
        function _() {
          ...
          O.length && O.remove(), w || o.append(d);
        }
        return t;
      })
    );
  ...
  var Hi = u((XW, Ys) => {
    ...
    var Nm = window.jQuery,
      ...
      xm = {
        ...
        intro: function (e, t) {
          ki.triggers.intro(e, t), Ks(t, "COMPONENT_ACTIVE");
        },
        outro: function (e, t) {
          ki.triggers.outro(e, t), Ks(t, "COMPONENT_INACTIVE");
        },
      };
    dn.triggers = {};
    dn.types = { INTRO: "w-ix-intro" + zs, OUTRO: "w-ix-outro" + zs };
  ...
  var Cu = u((oB, Ru) => {
    ...
    !hn &&
      ...
      ((Je = eo.match(/Edge\/(\d+)/)),
      (!Je || Je[1] >= 74) &&
        ((Je = eo.match(/Chrome\/(\d+)/)), Je && (hn = +Je[1])));
    Ru.exports = hn;
  });
  var to = u((aB, xu) => {
    var Nu = Cu(),
  ...
  var En = u((vB, ku) => {
    ...
    ku.exports = function (e, t) {
      try {
        gI(ju, e, { value: t, configurable: !0, writable: !0 });
      } catch {
        ju[e] = t;
      }
      return t;
  ...
  var uo = u((yB, Ju) => {
    ...
    Ju.exports = function (e) {
      return "Symbol(" + (e === void 0 ? "" : e) + ")_" + xI(++CI + NI, 36);
    };
  });
  var co = u((mB, ic) => {
    var qI = ge(),
  ...
  var uc = u((IB, sc) => {
    ...
    sc.exports = function (e, t) {
      ...
      if (r) {
        if (
          (t === void 0 && (t = "default"), (n = FI(r, e, t)), !oc(n) || ac(n))
        )
          return n;
  ...
  var vo = u((bB, dc) => {
    ...
    dc.exports =
      ...
      !zI(function () {
        return (
          Object.defineProperty(YI("div"), "a", {
            get: function () {
              return 7;
            },
          }).a != 7
  ...
  var ho = u((vc) => {
    ...
    vc.f = QI
      ...
      : function (t, r) {
          ...
          if (rT(t, r)) return JI(!$I(ZI.f, t, r), t[r]);
        };
  });
  var Nr = u((AB, Ec) => {
    var hc = ge(),
  ...
  var Pc = u((PB, qc) => {
    ...
    var bt, Cc, To, Nc, Ft;
    qc.exports = { set: mn, get: qr, has: In, enforce: CT, getterFor: NT };
  });
  var Dc = u((LB, Mc) => {
    var bo = Mt(),
      xT = Ot(),
    ...
    Mc.exports = { EXISTS: So, PROPER: PT, CONFIGURABLE: LT };
  });
  var Vc = u((MB, Uc) => {
    var MT = ge(),
      Fc = ut(),
  ...
  var Co = u((VB, Zc) => {
    ...
    Zc.exports = function (e, t) {
      var r = tO(e),
        ...
        o = [],
        i;
      for (i in r) !Ro(nO, i) && Ro(r, i) && $c(o, i);
      for (; t.length > n; ) Ro(r, (i = t[n++])) && (~rO(o, i) || $c(o, i));
      return o;
    };
  });
  var Tn = u((WB, Jc) => {
    ...
    ll.exports = function (e, t) {
      ...
      if (
        ...
        for (s in t) {
          if (
            ((d = t[s]),
            e.noTargetGet ? ((h = bO(a, s)), (c = h && h.value)) : (c = a[s]),
          ...
          (e.sham || (c && c.sham)) && SO(d, "sham", !0), AO(a, s, d, e);
        }
    };
  });
  var pl = u((YB, dl) => {
        ...
        bn =
          typeof document < "u"
            ? document.domain && On
              ...
              : jO()
            : Il(On);
        for (var e = _l.length; e--; ) delete bn[qo][_l[e]];
        return bn();
      };
    UO[Tl] = !0;
    bl.exports =
      ...
      function (t, r) {
        ...
        return (
          t !== null
            ? ((xo[qo] = GO(t)), (n = new xo()), (xo[qo] = null), (n[Tl] = t))
            : (n = bn()),
          r === void 0 ? n : XO(n, r)
        );
      };
  ...
  var wl = u((JB, Al) => {
    var kO = co(),
      ...
      Lo = kO("unscopables"),
      Mo = Array.prototype;
    Mo[Lo] == null && KO.f(Mo, Lo, { configurable: !0, value: HO(null) });
  ...
  var Bo = u((Mr) => {
    ...
    var nf = (Mr.ActionTypes = { INIT: "@@redux/INIT" });
    function af(e, t, r) {
      var n;
      if (
      ...
      function _(w) {
        ...
        for (var L = (a = s), C = 0; C < L.length; C++) L[C]();
        return w;
      }
      function O(w) {
        if (typeof w != "function")
      ...
      return (
        _({ type: nf.INIT }),
        (n = { dispatch: _, subscribe: p, getState: h, replaceReducer: O }),
        (n[rf.default] = S),
        n
      );
    }
  ...
  var nr = u((ye) => {
    ...
    function qf(e, t, r, n, o, i) {
      for (
        ...
        s[c - 6] = arguments[c];
      return s.length
        ? Ue.call.apply(Ue, [null, !1, !1, e, t, r, n, o, i].concat(s))
        : Ue(!1, !1, e, t, r, n, o, i);
    }
    function Pf(e, t, r, n, o, i) {
      for (
        ...
        s[c - 6] = arguments[c];
      return s.length
        ? Ue.call.apply(Ue, [null, !1, !0, e, t, r, n, o, i].concat(s))
        : Ue(!1, !0, e, t, r, n, o, i);
    }
    function Lf(e, t, r, n, o, i, a) {
      ...
      return (
        h.length
          ? (c = Ue.call.apply(Ue, [null, !1, !1, s, r, n, o, i, a].concat(h)))
          : (c = Ue(!1, !1, s, r, n, o, i, a)),
        Pn(e, t, c)
      );
    }
    function Mf(e, t) {
    ...
    function Df(e, t, r, n, o, i) {
      for (
        ...
        s[c - 6] = arguments[c];
      return s.length
        ? Ue.call.apply(Ue, [null, !0, !1, e, t, r, n, o, i].concat(s))
        : Ue(!0, !1, e, t, r, n, o, i);
    }
    var i0 = {
      clone: Nn,
  ...
  var ca = u((Rk, lp) => {
    ...
    function VR(e, t, r, n, o, i) {
      ...
      for (i.set(e, t), i.set(t, e); ++p < s; ) {
        var S = e[p],
          w = t[p];
        if (n) var L = a ? n(w, S, p, t, e, i) : n(S, w, p, e, t, i);
        if (L !== void 0) {
          if (L) continue;
          _ = !1;
          break;
        ...
        if (O) {
          if (
            !FR(t, function (C, N) {
              if (!GR(O, N) && (S === C || o(S, C, r, n, i))) return O.push(N);
            })
          ) {
            _ = !1;
            break;
  ...
  var lv = u((tH, cv) => {
    ...
    function tx(e, t, r, n, o, i) {
      ...
      for (var p = c; p--; ) {
        var _ = s[p];
        if (!(a ? _ in t : ex.call(t, _))) return !1;
      }
      var O = i.get(e),
        S = i.get(t);
      ...
      for (var L = a; ++p < c; ) {
        ...
        var C = e[_],
          N = t[_];
        if (n) var b = a ? n(N, C, _, t, e, i) : n(C, N, _, e, t, i);
  ...
  var Kn = u((aH, bv) => {
    var ga = dv(),
      ...
      yx = lr(Ia),
      Xt = Ov;
    ((ga && Xt(new ga(new ArrayBuffer(1))) != Tv) ||
      (_a && Xt(new _a()) != _v) ||
      (ya && Xt(ya.resolve()) != yv) ||
      (ma && Xt(new ma()) != mv) ||
      (Ia && Xt(new Ia()) != Iv)) &&
    ...
    function Ax(e, t, r, n, o, i) {
      ...
      if (!(r & bx)) {
        ...
        if (O || S) {
          var w = O ? e.value() : e,
            L = S ? t.value() : t;
          return i || (i = new Ta()), o(w, L, r, n, i);
        }
      }
      return _ ? (i || (i = new Ta()), Tx(e, t, r, n, o, i)) : !1;
    }
    xv.exports = Ax;
  });
  var Oa = u((uH, Mv) => {
    ...
    function qx(e, t, r, n) {
      ...
      for (; ++o < i; ) {
        ...
        if (a && s[2]) {
          ...
          var p = new Rx();
          if (n) var _ = n(d, h, c, e, t, p);
          if (!(_ === void 0 ? Cx(h, d, Nx | xx, n, p) : _)) return !1;
        }
      }
      return !0;
    }
  ...
  var Yn = u((hH, kv) => {
    ...
    function $x(e, t) {
      ...
      return r == "number" ||
        ...
        zx(e)
        ? !0
        : Qx.test(e) || !Yx.test(e) || (t != null && e in Object(t));
    }
    kv.exports = $x;
  });
  var zv = u((EH, Kv) => {
  ...
  var oh = u((mH, ih) => {
    ...
    function nh(e) {
      ...
      if (uq(e)) return sq(e, nh) + "";
      if (cq(e)) return rh ? rh.call(e) : "";
      var t = e + "";
  ...
  var Vh = u((WH, Uh) => {
    ...
    function LP(e, t, r) {
      ...
      if (!n) return -1;
      var o = r == null ? 0 : qP(r);
      return o < 0 && (o = PP(n + o, 0)), NP(e, xP(t, 3), o);
    }
    Uh.exports = LP;
  });
  var qa = u((BH, Wh) => {
  ...
  var Pa = u((kH, Qh) => {
    ...
    Qh.exports = function (t, r, n, o) {
      ...
      function s(c) {
        for (var d = 0, h = 1, p = Kr - 1; h !== p && i[h] <= c; ++h) d += ri;
        --h;
  ...
  var La = u((re) => {
    ...
    var ii = QP(Pa()),
      mt = 1.70158,
      $P = (0, ii.default)(0.25, 0.1, 0.25, 1);
    re.ease = $P;
    var ZP = (0, ii.default)(0.42, 0, 1, 1);
    re.easeIn = ZP;
    var JP = (0, ii.default)(0, 0, 0.58, 1);
    re.easeOut = JP;
  ...
  var Da = u((zr) => {
    ...
    function GL(e, t, r) {
      return t === 0
        ...
        : t === 1
        ? 1
        : Ma(r ? (t > 0 ? r(t) : t) : t > 0 && e && $h[e] ? $h[e](t) : t);
    }
  });
  var tE = u((dr) => {
    "use strict";
        ...
        switch (t.type) {
          ...
          case YL: {
            let {
              ...
              c = e;
            return (
              (0, oi.getIn)(c, [r, n]) !== n && (c = eE(c, n, a, r, i)),
              Fa(c, r, s, o, i)
            );
          }
          case QL: {
    ...
    function eE(e, t, r, n, o) {
      let i =
        r === XL ? (0, oi.getIn)(o, ["config", "target", "objectId"]) : null;
    ...
    var nE = Object.freeze({
      ...
      pM = (e, t) => {
        ...
        if (e) {
          let i = Object.keys(e),
            a = lM(n, i);
          return a.length ? a.reduce((c, d) => ((c[d] = nE[d]), c), e) : e;
        }
  ...
  var uE = u((ai) => {
    ...
    var oE = _M(rr()),
      ...
      mM = sE(iE()),
      IM = new Map([
        [aE.ActionTypeConsts.PLUGIN_LOTTIE, (0, oE.default)({}, yM)],
        [aE.ActionTypeConsts.PLUGIN_SPLINE, (0, oE.default)({}, mM)],
      ]);
  ...
  var xE = u((si) => {
    ...
    function sD(e, t) {
      ...
      for (let o = 0; o < r.length; o++)
        if (!aD.call(t, r[o]) || !NE(e[r[o]], t[r[o]])) return !1;
      return !0;
    }
    var uD = sD;
    si.default = uD;
  ...
  var QE = u((pe) => {
    ...
    var Rt = fi(fE()),
      ...
      jE = (e) => e.trim(),
      Ha = Object.freeze({ [_r]: UE, [yr]: mD, [mr]: ID }),
      kE = Object.freeze({
    ...
    function Ka({
      ...
      if (b) return [ui.has(b) ? ui.get(b) : ui.set(b, {}).get(b)];
      ...
      if (
        (ne
          ? ((J = H.limitAffectedElements), (X = D), (I = h(H)))
          : (X = I = h({ id: N, selector: M, selectorGuids: q })),
        t && U)
      ) {
        let G = r && (I || U === !0) ? [r] : p(D);
        if (I) {
          if (U === OD) return p(I).filter((V) => G.some((Q) => w(V, Q)));
          if (U === PE) return p(I).filter((V) => G.some((Q) => w(Q, V)));
          if (U === LE) return p(I).filter((V) => G.some((Q) => L(Q, V)));
        }
        return G;
      }
        ...
        case gr: {
          ...
          return (
            ...
            n.config.heightUnit === Ct
              ? (h = DE.test(c) ? parseFloat(c) : parseFloat(r.height))
              : (h = (0, Rt.default)(parseFloat(c), parseFloat(r.height))),
    ...
    function VD({ element: e, actionItem: t, elementApi: r }) {
      ...
      switch (t.actionTypeId) {
        ...
        case gr: {
          ...
          if (a === Ct) {
            let h = n(e, ft);
            o(e, ft, ""), (c = i(e, "offsetWidth")), o(e, ft, h);
          }
          if (s === Ct) {
            let h = n(e, dt);
            o(e, dt, ""), (d = i(e, "offsetHeight")), o(e, dt, h);
          }
    ...
    function BD(e, t, r, n, o, i, a, s, c) {
      switch (s) {
        ...
        case WE: {
          ...
          if ((0, pt.isPluginType)(d)) return (0, pt.renderPlugin)(d)(c, t, o);
        }
      }
    }
    var za = {
    ...
    function YD(e, t, r, n) {
      let o = (0, Ba.default)(t, (a, s, c) => `${a} ${c}(${s}${HD(c, r)})`, ""),
        { setStyle: i } = n;
      Wt(e, Yr, n), i(e, Yr, o);
    }
    function QD(e, t, r, n) {
    ...
    function n1(e, t, r, n, o, i) {
      ...
      switch (n.actionTypeId) {
        case gr: {
          ...
          d !== void 0 &&
            (s === Ct && (s = "px"), Wt(e, ft, i), a(e, ft, d + s)),
            h !== void 0 &&
              (c === Ct && (c = "px"), Wt(e, dt, i), a(e, dt, h + c));
          break;
        }
        case Jr: {
          YD(e, r, n.config, i);
    ...
    function o1({ store: e, elementApi: t }) {
      ...
      Object.keys(n).forEach((i) => {
        let a = n[i],
          ...
          { actionListId: c } = s,
          d = o[c];
        d && FE({ actionList: d, event: a, elementApi: t });
      }),
        Object.keys(o).forEach((i) => {
          FE({ actionList: o[i], elementApi: t });
        });
    }
    ...
    function GE({ actionGroup: e, event: t, elementApi: r }) {
      ...
      n.forEach(({ actionTypeId: o, config: i }) => {
        ...
        (0, pt.isPluginType)(o)
          ...
          : (a = zE({ effect: s1, actionTypeId: o, elementApi: r })),
    ...
    function a1(e, t, r) {
      ...
      o(e, pr) && zE({ effect: KE, actionTypeId: i, elementApi: r })(e);
    }
    var zE =
        ...
        for (let k = 0, { length: H } = o; k < H; k++) {
          ...
          if ((k === 0 && (b = J[0]), N >= ne)) {
            ...
            (M = I ? X.actionItems[0] : null),
              I && ((q = ne / 100), (P = (X.keyframe - ne) / 100));
          }
        }
        let U = {};
        if (b && !M)
      ...
      q1 = (e, t) => {
        ...
        if (r && n) {
          ...
          if (s) {
            ...
            e = (0, Tr.set)(e, "verboseTimeElapsed", H * ne);
          }
          if (b < 0) return e;
        ...
        switch (t.type) {
          ...
          case O1: {
            ...
            return (0, Tr.set)(e, r, {
              ...
              skipToValue: k,
              customEasingFn:
                Array.isArray(I) && I.length === 4 ? w1(I) : void 0,
            });
          }
          case b1: {
  ...
  var Tg = u((b5, Ig) => {
    ...
    function LF(e) {
      if (e == null) return 0;
      if (CF(e)) return NF(e) ? xF(e) : e.length;
      var t = RF(e);
  ...
  var Cg = u((R5, Rg) => {
    ...
    function jF(e, t, r) {
      var n = e[t];
      (!(BF.call(e, t) && VF(n, r)) || (r === void 0 && !(t in e))) &&
        UF(e, t, r);
    }
    Rg.exports = jF;
  });
  ...
  var c_ = u((j5, u_) => {
    ...
    function sG(e, t, r) {
      ...
      function O(P) {
        var U = n,
          k = o;
        return (n = o = void 0), (d = P), (a = e.apply(k, U)), a;
      }
      function S(P) {
        return (d = P), (s = setTimeout(C, t)), h ? O(P) : a;
      }
      function w(P) {
        var U = P - c,
          k = P - d,
      ...
      function N(P) {
        return (s = void 0), _ && n ? O(P) : ((n = o = void 0), a);
      }
      function b() {
      ...
      function q() {
        var P = es(),
          U = L(P);
        if (((n = arguments), (o = this), (c = P), U)) {
          if (s === void 0) return S(c);
          if (p) return clearTimeout(s), (s = setTimeout(C, t)), O(c);
        }
        return s === void 0 && (s = setTimeout(C, t)), a;
      }
      return (q.cancel = b), (q.flush = M), q;
    }
    u_.exports = sG;
  });
  var f_ = u((k5, l_) => {
  ...
  var gi = u((oe) => {
    ...
    var d_ = dG(rr()),
      ...
      MG = (e) => ({ type: vG, payload: (0, d_.default)({}, LG(e)) });
    ...
    var VG = (e) => ({ type: mG, payload: { actionListId: e } });
    oe.stopRequested = VG;
    var WG = () => ({ type: IG });
    ...
    var kG = (e, t) => ({ type: bG, payload: { stateKey: e, newState: t } });
    oe.eventStateChanged = kG;
    var HG = (e, t) => ({ type: SG, payload: { now: e, parameters: t } });
    ...
    var QG = (e) => ({ type: CG, payload: { instanceId: e } });
  ...
  var E_ = u((xe) => {
    ...
    function cX({ id: e, selector: t }) {
      if (e) {
        ...
        if (e.indexOf(v_) !== -1) {
          let n = e.split(v_),
            o = n[0];
          if (((r = n[1]), o !== document.documentElement.getAttribute(h_)))
            return null;
        }
    ...
    var EX = Element.prototype.closest
  ...
  var is = u((fK, ry) => {
    ...
    function tU(e) {
      for (
        var t = e.name + "", r = ty[t], n = eU.call(ty, t) ? r.length : 0;
        n--;
  ...
  var ly = u((hK, cy) => {
    ...
    function Oi(e) {
      if (pU(e) && !dU(e) && !(e instanceof lU)) {
        ...
        if (EU.call(e, "__wrapped__")) return vU(e);
      }
      return new uy(e);
    }
  ...
  var Ey = u((gK, hy) => {
    ...
    function NU(e) {
      return TU(function (t) {
        ...
        for (e && t.reverse(); n--; ) {
          var i = t[n];
          if (typeof i != "function") throw new TypeError(SU);
        ...
        return function () {
          var d = arguments,
            h = d[0];
          if (a && d.length == 1 && bU(h)) return a.plant(h).value();
  ...
  var Uy = u((Ri) => {
    ...
    var ke = wi(rr()),
        ...
        return (
          d &&
            (0, ss.stopActionGroup)({
              ...
              actionListId: (0, FU.default)(d, "action.config.actionListId"),
            }),
          (0, ss.stopActionGroup)({
            store: e,
            eventId: a,
      ...
      on = { handler: tt(vt, Ve) },
      Gy = (0, ke.default)({}, on, { types: [us, My].join(" ") }),
      cs = [
      ...
      ls = { types: cs },
      cV = { PAGE_START: Ly, PAGE_FINISH: Py },
      rn = (() => {
      ...
      pV = (e) => (t, r) => {
        let n = (0, ke.default)({}, r, { elementVisible: dV(t) });
        return (
      ...
      Cy = (0, ke.default)({}, ls, {
        handler: pV((e, t) => {
          ...
          return !a[n.action.config.autoStopEventId] && t.triggered
            ? t
            : (n.eventTypeId === qy) === r
            ? (Ve(e), (0, ke.default)({}, t, { triggered: !0 }))
            : t;
        }),
      }),
      Ny = 0.05,
      gV = {
        ...
        [QU]: Si(),
        [$U]: Ai(),
        [oV]: { types: "ecommerce-cart-open", handler: tt(vt, Ve) },
        [iV]: { types: "ecommerce-cart-close", handler: tt(vt, Ve) },
        [UU]: {
          types: "click",
          handler: tt(
            vt,
        ...
        [WU]: (0, ke.default)({}, on, { types: "mousedown" }),
        [BU]: (0, ke.default)({}, on, { types: "mouseup" }),
        [jU]: {
          types: Sy,
          handler: tt(
            vt,
        ...
        [eV]: {
          ...
          handler: (
            ...
            return (
              ...
              (a !== jt.EventBasedOn.ELEMENT || b || b !== i.elementHovered) &&
                ((C = d ? 1 - C : C),
                e.dispatch((0, bi.parameterChanged)(N, C))),
              { elementHovered: b, clientX: p, clientY: _, pageX: O, pageY: S }
            );
          },
        },
        [aV]: {
        ...
        [nV]: {
          ...
          handler: (
            ...
            if (h === jt.EventBasedOn.VIEWPORT) {
              ...
              return (
                M !== o.scrollPercent &&
                  t.dispatch((0, bi.parameterChanged)(_, M)),
                { scrollPercent: M }
              );
            } else {
              let M = by(n, _),
              ...
              return (
                I !== o.scrollPercent &&
                  t.dispatch((0, bi.parameterChanged)(M, I)),
                { scrollPercent: I }
              );
            }
          },
  ...
  var fs = u((xt) => {
    ...
    var yV = nt(rr()),
      ...
      KV = 12;
    function zV(e) {
      kt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: $V }),
        kt({
          store: e,
        ...
        kt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: eW });
    }
    function YV(e) {
      kt({
        store: e,
    ...
    function $V({ rawData: e, defer: t }, r) {
      let n = () => {
        Pi({ store: r, rawData: e, allowEvents: !0 }), Hy();
      };
      t ? setTimeout(n, 0) : n();
    }
    function Hy() {
    ...
    function ZV(e, t) {
      ...
      if (n && o && h && s) {
        ...
        p && (h = FV({ actionList: p, actionItemId: o, rawData: h }));
      }
      if (
        (Pi({ store: t, rawData: h, allowEvents: a, testManual: c }),
    ...
    function JV({ actionListId: e }, t) {
      e ? Es({ store: t, actionListId: e }) : Yy({ store: t }), Li(t);
    }
    function eW(e, t) {
      Li(t), ky({ store: t, elementApi: be });
    }
    ...
    function Li(e) {
      ...
      if (t.active) {
        ...
        r.forEach(nW), VV(), e.dispatch((0, me.sessionStopped)());
      }
    }
    ...
    function iW({
      ...
      C.forEach((M) => {
        ...
        L.forEach(({ element: M, key: q }) => {
          let P = w[q],
            U = (0, Nt.default)(P, "[0].actionItems[0]", {}),
            { actionTypeId: k } = U,
            H = qi(k) ? hs(k)(M, U) : null,
            ne = vs({ element: M, actionItem: U, elementApi: be }, H);
          _s({
            store: e,
            element: M,
            eventId: n,
    ...
    var cW = (e, t) => (0, OV.default)((0, SV.default)(e, t), bV.default),
      lW = (e, t) => {
        (0, an.default)(e, (r, n) => {
          r.forEach((o, i) => {
            let a = n + ps + i;
      ...
      fW = (e) => {
        ...
        return Ni({ config: t, elementApi: be });
      };
    function dW({ logic: e, store: t, events: r }) {
      ...
      (0, an.default)(s, (p, _) => {
        ...
        BV(L, i.mediaQueryKeys) || t.dispatch((0, me.mediaQueriesDefined)()),
          S.actionTypeId === rt.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(O.config) ? O.config : [O.config]).forEach((b) => {
              let { continuousParameterGroupId: M } = b,
                q = (0, Nt.default)(a, `${C}.continuousParameterGroups`, []),
                P = (0, IV.default)(q, ({ id: H }) => H === M),
                U = (b.smoothing || 0) / 100,
          ...
          (S.actionTypeId === rt.ActionTypeConsts.GENERAL_START_ACTION ||
            ds(S.actionTypeId)) &&
            zy({ store: t, actionListId: C, eventId: w });
      });
      let c = (p) => {
          ...
          lW(s, (O, S, w) => {
            ...
            if (!xi(b, _.mediaQueryKey)) return;
            let M = (q = {}) => {
              let P = o(
                {
                  store: t,
              ...
              jV(P, C) || t.dispatch((0, me.eventStateChanged)(w, P));
            };
          ...
          _.split(" ")
            ...
            .forEach((S) => {
              ...
              p.addEventListener(S, w),
                t.dispatch((0, me.eventListenerAdded)(p, [S, w]));
            });
        };
    ...
    function zy({ store: e, actionListId: t, eventId: r }) {
      ...
      if (c && c.useFirstGroupAsInitialState) {
        let d = (0, Nt.default)(c, "actionItemGroups[0].actionItems", []),
          h = (0, Nt.default)(s, "mediaQueries", n.mediaQueryKeys);
        if (!xi(h, o.mediaQueryKey)) return;
        d.forEach((p) => {
          var _;
          let { config: O, actionTypeId: S } = p,
            w =
              (O == null || (_ = O.target) === null || _ === void 0
                ? void 0
                : _.useEventTarget) === !0
                ? { target: s.target, targets: s.targets }
                : O,
            L = Ni({ config: w, event: s, elementApi: be }),
            C = qi(S);
          L.forEach((N) => {
            let b = C ? hs(S)(N, p) : null;
            _s({
              destination: vs({ element: N, actionItem: p, elementApi: be }, b),
              immediate: !0,
              store: e,
              element: N,
              eventId: r,
    ...
    function gs({
      ...
      let { ixData: d, ixSession: h } = e.getState(),
        ...
        S = (0, Nt.default)(d, `actionLists.${o}`, {}),
        { actionItemGroups: w, useFirstGroupAsInitialState: L } = S;
      if (!w || !w.length) return !1;
      i >= w.length && (0, Nt.default)(_, "config.loop") && (i = 0),
        i === 0 && L && i++;
      let N =
          (i === 0 || (i === 1 && L)) &&
          ds((c = _.action) === null || c === void 0 ? void 0 : c.actionTypeId)
            ? _.config.delay
            : void 0,
        b = (0, Nt.default)(w, [i, "actionItems"], []);
      if (!b.length || !xi(O, h.mediaQueryKey)) return !1;
      ...
      return (
        b.forEach((U, k) => {
          ...
          Ni({
            ...
            P = !0;
            let F = q === k && V === 0,
              j = MV({ element: G, actionItem: U }),
              f = vs({ element: G, actionItem: U, elementApi: be }, Q);
            _s({
              store: e,
              element: G,
              actionItem: U,
    ...
    function _s(e) {
      ...
      let { store: r, computedStyle: n } = e,
        ...
        _ = !d,
        O = qV(),
        { ixElements: S, ixSession: w, ixData: L } = r.getState(),
        C = xV(S, i),
        { refState: N } = S[C] || {},
        b = be.getRefType(i),
        M = w.reducedMotion && rt.ReducedMotionTypes[a.actionTypeId],
        q;
      if (M && d)
        switch (
      ...
      kt({ store: r, select: ({ ixInstances: U }) => U[O], onChange: $y }),
        _ && r.dispatch((0, me.instanceStarted)(O, w.tick));
    }
    function ys(e, t) {
      ...
      let { elementId: r, actionItem: n } = e,
        ...
        { ref: i, refType: a } = o[r] || {};
      a === jy && UV(i, n, be), t.dispatch((0, me.instanceRemoved)(e.id));
    }
    function Qy(e, t, r) {
    ...
    function $y(e, t) {
      ...
      if (xi(U, M.mediaQueryKey) && (n || r || o)) {
        if (d || (c === NV && o)) {
          t.dispatch((0, me.elementStateChanged)(i, s, d, a));
  ...
  var Jy = u((It) => {
    ...
    var gW = $o(),
      ...
      yW = hW(gi());
    It.actions = yW;
    var Mi = (0, gW.createStore)(_W.default);
    It.store = Mi;
    function mW(e) {
      e() && (0, ms.observeRequests)(Mi);
    }
    function IW(e) {
      Zy(), (0, ms.startEngine)({ store: Mi, rawData: e, allowEvents: !0 });
    }
    function Zy() {
      (0, ms.stopEngine)(Mi);
    }
      ...
      (im.exports = function (e, t) {
        ...
        function O() {
          (o = i && Or.env("design")),
            ...
            Or.scroll.off(w),
            (p = []);
          for (var C = document.links, N = 0; N < C.length; ++N) S(C[N]);
          p.length && (Or.scroll.on(w), w());
        }
        function S(C) {
          var N =
            (o && C.getAttribute("href-disabled")) || C.getAttribute("href");
          if (((s.href = N), !(N.indexOf(":") >= 0))) {
            ...
            if (
              ...
              var M = e(s.hash);
              M.length && p.push({ link: b, sec: M, active: !1 });
              return;
            }
            if (!(N === "#" || N === "")) {
            ...
            if (a) {
              ...
              (h = N),
                Math.abs(b) > c &&
                  r &&
                  String(r()) === "" &&
                  (o("swipe", L, { direction: b > 0 ? "right" : "left" }), S());
            }
          }
          function O(L) {
    ...
    Fi.define(
      ...
      (fm.exports = function (e, t) {
        ...
        function M() {
          ...
          n.on(
            ...
            n.on("change", s + ' form input[type="radio"]', (z) => {
              e(`input[name="${z.target.name}"]:not(${F})`).map((ce, Ae) =>
        ...
        function k(F) {
          var j = {};
          return (
            F.find(':input[type="file"]').each(function (f, E) {
              var g = e(E),
                v = g.attr("data-name") || g.attr("name") || "File " + (f + 1),
                B = g.attr("data-value");
              typeof B == "string" && (B = e.trim(B)), (j[v] = B);
            }),
            j
          );
        }
        ...
        function V(F, j) {
          ...
          var f,
            ...
            ce = g.find(".w-file-upload-label"),
            Ae = ce.children(),
            le = z.find(".w-file-upload-error-msg"),
            Ee = B.find(".w-file-upload-file"),
            We = B.find(".w-file-remove-link"),
            Be = Ee.find(".w-file-upload-file-name"),
            it = le.attr("data-w-size-error"),
            qe = le.attr("data-w-type-error"),
            Et = le.attr("data-w-generic-error");
          if (
            (_ ||
              ce.on("click keydown", function (m) {
          ...
          function y(m, R) {
            ...
            var K = R.fileName,
              ...
              ve = R.fileId,
              W = R.s3Url;
            Y.attr("data-value", ve), ee(W, te, f, K, T);
          }
          function T(m) {
            if (m) return l(m);
            v.toggle(!1),
    ...
    qt.define(
      ...
      (vm.exports = function (e, t) {
        ...
        (r.ready = function () {
          ...
          (r.destroy = L);
        function w() {
          (i = o.find(c)), i.length && (i.each(b), !O && (L(), C()));
        }
        function L() {
        ...
        function b(f, E) {
          ...
          if (
            (B || ((B = "w-slider-mask-" + f), v.mask.attr("id", B)),
          ...
          v.el.off(c),
            ...
            M(v),
            a
              ? (v.el.on("setting" + c, I(v)), X(v), (v.hasTimer = !1))
              : (v.el.on("swipe" + c, I(v)),
                ...
                v.config.autoplay &&
                  !v.hasTimer &&
                  ((v.hasTimer = !0), (v.timerCount = 1), J(v)),
          ...
          Y.addClass(p), S || V(f, E), z.removeClass(p), Y.removeClass(p);
        }
        function M(f) {
          var E = {};
          (E.crossOver = 0),
          ...
          if (
            ((E.duration = g != null ? parseInt(g, 10) : 500),
        ...
        function I(f) {
          return function (E, g) {
            ...
            var v = f.config;
            if (a && E.type === "setting") {
              if (g.select === "prev") return k(f)();
              if (g.select === "next") return H(f)();
              if ((M(f), Q(f), g.select == null)) return;
              ne(f, g.select);
              return;
            }
            if (E.type === "swipe")
              return v.disableSwipe || qt.env("editor")
                ? void 0
                : g.direction === "left"
                ? H(f)()
                : g.direction === "right"
            ...
            if (f.nav.has(E.target).length) {
              ...
              if (
                (E.type === "click" && G(f, { index: B }), E.type === "keydown")
              )
                switch (E.keyCode) {
                  case ht.ENTER:
                  case ht.SPACE: {
                    G(f, { index: B }), E.preventDefault();
                    break;
                  }
                  case ht.ARROW_LEFT:
                  case ht.ARROW_UP: {
                    D(f.nav, Math.max(B - 1, 0)), E.preventDefault();
                    break;
                  }
                  case ht.ARROW_RIGHT:
                  case ht.ARROW_DOWN: {
                    D(f.nav, Math.min(B + 1, f.pages)), E.preventDefault();
                    break;
                  }
                  case ht.HOME: {
                    D(f.nav, 0), E.preventDefault();
                    break;
                  }
                  case ht.END: {
                    D(f.nav, f.pages), E.preventDefault();
                    break;
                  }
                  default:
                    return;
        ...
        function G(f, E) {
          ...
          B < 0
            ? ((B = v.length - 1),
              g.infinite &&
                ((z.x = -f.endX), (z.from = 0), (z.to = v[0].width)))
            : B >= v.length &&
              ((B = 0),
              g.infinite &&
          ...
          if (
            (Ee.find(pm).removeAttr("tabindex"),
            ...
            a || (Ee.each(_.intro), Be.each(_.outro)),
            E.immediate && !S)
          ) {
            n(Ee).set(le), m();
            return;
          ...
          if (
            (a || f.ariaLiveLabel.text(`Slide ${B + 1} of ${v.length}.`),
            it === "cross")
          ) {
        ...
        function Q(f) {
          ...
          Y < 0 && (Y = 0),
            ...
            (f.endX = v),
            a && (f.pages = null),
            f.nav.length && f.pages !== E && ((f.pages = E), ee(f));
          var ce = f.index;
          ce >= E && (ce = E - 1), G(f, { immediate: !0, index: ce });
        }
        function ee(f) {
          var E = [],
            g,
          ...
          for (var B = 0, z = f.pages; B < z; B++)
            (g = e(d)),
              g
                .attr("aria-label", "Show slide " + (B + 1) + " of " + z)
                .attr("aria-pressed", "false")
                .attr("role", "button")
                .attr("tabindex", "-1"),
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-11": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "9bf80744-7093-d2d6-af44-cd2eece1cec3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-17": {
      ...
      target: {
        selector: ".stack-item",
        originalId:
          "64470065adf2a695cbbcbb51|76333e03-6ce4-622f-04fd-4a99c5b34f52",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-19": {
      ...
      target: {
        selector: ".work-item",
        originalId: "2dc7b6c2-3a77-b73c-20c2-f28e3f8c080b",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".logo-item-gradient",
        originalId:
          "64470065adf2a6640cbcbb4c|5c432c35-47bd-a0bc-57cf-39a458629ccf",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-23": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".dribbble-item",
        originalId:
          "64470065adf2a6640cbcbb4c|d2dfc25b-3d28-f415-b3ea-550c4c83d6aa",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-25": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "79e3515e-b4c7-ffaa-cc9a-e7f2ce7fb9cf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-27": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "79e3515e-b4c7-ffaa-cc9a-e7f2ce7fb9d2",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-37": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "2dc7b6c2-3a77-b73c-20c2-f28e3f8c080b",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-43": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "2dc7b6c2-3a77-b73c-20c2-f28e3f8c0817",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-47": {
      ...
      target: {
        selector: ".work-item",
        originalId:
          "64470065adf2a67457bcbb56|5474775f-b018-81f0-5e66-e4824e328001",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-71": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "3a0b05a0-5c3e-ee6f-627a-2885071a73c4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-73": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "3a0b05a0-5c3e-ee6f-627a-2885071a73c7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6d412bcbb52|0d47c1b9-59e9-78cb-b4bb-0ce04ca24a30",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6d412bcbb52|0d47c1b9-59e9-78cb-b4bb-0ce04ca24a32",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6d412bcbb52|99262cce-c940-da66-8962-37f8bd87d0f8",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6d412bcbb52|0e522054-104c-104a-8645-a88b9283811c",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6d412bcbb52|e5a14b17-f3ca-8b2d-ccd1-37e4a4a66478",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
    ...
    "a-5": {
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".arrow-up-initial-hover",
                  selectorGuids: ["6d162032-6f4d-da3c-82d4-08cde66240b4"],
                },
                value: 0,
                unit: "",
              },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "9bf80744-7093-d2d6-af44-cd2eece1cec9",
                },
                value: 1,
                unit: "",
              },
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1681073619846,
    },
    "a-6": {
      id: "a-6",
      title: "primary-button-hover 2",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-11": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".stack-item",
                  selectorGuids: ["9bcd910e-5bd1-6382-e841-4eef5a9e7913"],
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "px",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1681159563169,
    },
    "a-12": {
      id: "a-12",
      title: "stack-item-hover 2",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-13": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "PARENT",
                  selector: ".work-item",
                  selectorGuids: ["dba8593c-848f-c07e-53e5-d7c95fa56f90"],
                },
                xValue: 1,
                yValue: 1,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".arrow",
                  selectorGuids: ["aa766a40-0a5e-550c-41cf-ea2392cb712c"],
                },
                value: 0,
                unit: "",
              },
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1681225781664,
    },
    "a-19": {
      id: "a-19",
      title: "work-item-hover 2",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "PARENT",
                  selector: ".logo-item-gradient",
                  selectorGuids: ["5963f349-0a43-900d-7fc7-3477c9618185"],
                },
                xValue: 1,
                yValue: 1,
                locked: true,
    ...
    "a-17": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "PARENT",
                  selector: ".dribbble-item",
                  selectorGuids: ["5f73f07e-eecf-686f-0018-964826f74244"],
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "px",
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1681225944234,
    },
    "a-18": {
      id: "a-18",
      title: "work-hover-img 2",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "64358bca79f18d59298551cb|19c94f36-99cc-86cb-a434-773f47539250",
                },
                yValue: 10,
                xUnit: "PX",
                yUnit: "%",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "64358bca79f18d59298551cb|f281aa50-9525-c3c5-6b9a-1ac0732007b7",
                },
                value: 0,
                unit: "",
              },
    ...
    "a-22": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  selector: ".outer-pulse",
                  selectorGuids: ["5be280fb-38a9-13ea-2f98-78e5b6bfcc8c"],
                },
                xValue: 0,
                yValue: 0,
                locked: true,
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1681309797775,
    },
    "a-25": {
      id: "a-25",
      title: "case-study-click",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6640cbcbb4c|5f075927b33f5315850a8719",
                },
                value: 1,
                unit: "",
              },
    ...
    "a-26": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a69e2abcbb54|5f075927b33f5315850a8719",
                },
                value: 0,
                unit: "",
              },
      ...
      useFirstGroupAsInitialState: true,
      createdOn: 1681378458827,
    },
    "a-30": {
      id: "a-30",
      title: "case-study-reveal 2",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a6de78bcbb55|5f075927b33f5315850a8719",
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a62beebcbb53|5f075927b33f5315850a8719",
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a5d9263dce7e3dfe2296f|5ad715ee-2198-3da2-52b2-d081ba90408a",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a5d9263dce7e3dfe2296f|8dd2ffaa-6b9c-d1d9-c8d1-8dc96ace5a7a",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a5d9263dce7e3dfe2296f|a0eb245e-389b-1365-0bdd-fed5155e3094",
                },
                yValue: -8,
                xUnit: "PX",
                yUnit: "px",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".row",
                  selectorGuids: ["8e297994-0f46-2d7c-3f2e-6de2125a7dd5"],
                },
                xValue: 0,
                xUnit: "vw",
                yUnit: "PX",
    ...
    "a-10": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".part-1",
                  selectorGuids: ["0c4363af-1585-9669-db4a-f9c43e6a37da"],
                },
                xValue: 0,
                xUnit: "vw",
                yUnit: "PX",
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1681129419760,
    },
    "a-3": {
      id: "a-3",
      title: "home-about-animation",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a78fc3dce3e527b8cc13a|14737ec6-f691-cb85-5c80-790f297b4424",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a78fc3dce3e527b8cc13a|14737ec6-f691-cb85-5c80-790f297b442b",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a78fc3dce3e527b8cc13a|14737ec6-f691-cb85-5c80-790f297b442a",
                },
                xValue: 0,
                yValue: 0,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "644a78fc3dce3e527b8cc13a|14737ec6-f691-cb85-5c80-790f297b4428",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a67457bcbb56|45012fe1-758b-47e2-eecf-451c6eeab9fb",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a67457bcbb56|45012fe1-758b-47e2-eecf-451c6eeab9ff",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64470065adf2a67457bcbb56|c11fc707-49a7-826e-7379-ff4464de23b2",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "644a5d9263dce7e3dfe2296f|19c94f36-99cc-86cb-a434-773f47539250",
                },
                yValue: 10,
                xUnit: "PX",
                yUnit: "%",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "644a5d9263dce7e3dfe2296f|f281aa50-9525-c3c5-6b9a-1ac0732007b7",
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64fa3a21a5950e9841a65199|14737ec6-f691-cb85-5c80-790f297b4424",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64fa3a21a5950e9841a65199|14737ec6-f691-cb85-5c80-790f297b442b",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64fa3a21a5950e9841a65199|14737ec6-f691-cb85-5c80-790f297b442a",
                },
                xValue: 0,
                yValue: 0,
                locked: true,
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "64fa3a21a5950e9841a65199|14737ec6-f691-cb85-5c80-790f297b4428",
                },
                xValue: -64,
                xUnit: "px",
                yUnit: "PX",
